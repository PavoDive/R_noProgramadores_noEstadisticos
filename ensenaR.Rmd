...
produccion <- read.xlsx(file = "https://github.com/PavoDive/R_noProgramadores_noEstadisticos/blob/master/archivos/produccionOperario.xlsx", sheetIndex = 1, stringsAsFactors = TRUE, encoding = "UTF-8")
